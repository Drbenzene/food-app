...
function Hero() {
  return (
    <section className='flex flex-col md:flex-row justify-between md:space-x-5 w-full mt-10  md:mt-20'>
        <div className='flex flex-col w-full md:w-[45%]  '>
            <h2 className='text-4xl lg:text-5xl text-primaryText font-bold'>
            Your Favorite Food <br/>Delivery Partner
            </h2>
        <p className="text-primaryText font-[400] mt-3 text:sm md:text-base  lg:text-lg ">The food at your doorstep. Why starve when you have us. You hunger partner. Straight out of the oven to your doorstep.  </p>
