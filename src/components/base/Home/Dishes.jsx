...
<section>
    <div className=' flex justify-center flex-col text-center mt-5 md:mt-10 '>
        ...
        <p className='text-primaryText mt-5 font-medium text-lg'>Welcome to The Biggest Network of Food Ordering & Delivery</p>
        ...
        <div className='w-full flex flex-col md:flex-row mt-10 justify-between items-center md:space-x-20 md:space-y-0 space-y-10 '>
            ...
            <div className='bg-secondary w-full rounded-2xl h-56 p-4 relative'>
                ...
                Find <span className='text-[#FF5331]'>deals</span>, <span className='text-[#009B00]'>free delivery</span>, and more <br/> from our restaurant partners.
                </h3>
        ...
        <div className='w-full flex flex-col md:flex-row mt-10 justify-between items-center md:space-x-20 md:space-y-0 space-y-1 '>
            <div className=' w-full rounded-2xl h-56 p-4 relative md:w-2/5'>
                ...
                <p className=' mt-10 md:mt-20 text-primaryText text-start'>Lorem ipsum dolor sit amet, consectetur <b/>adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
